...
const CategoryFilterData = ({ data, companies }) => {
    ...
    <div className={styles.Wrapper}>
        ...
        <>
          <div key={index} className={styles.checkbox}>
            <input  onChange={ async (e)  => {
              await dispatch(AparatProductGetFilter({ category : e.target.value , brand:CompanyId }))
      ...
      {companies.map((elem, index) => (
        <>
          <div key={index} className={styles.checkbox}>
            <input onChange={ async (e)  => {
              await dispatch(AparatProductGetFilter({brand : e.target.value , category:Category })) 
