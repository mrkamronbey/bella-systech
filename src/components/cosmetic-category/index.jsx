...
import {CosmeticsGet} from "../../redux/cosmetic/index"
import {CosmeticsCategoryGet} from "../../redux/cosmetic-category/index"
const BioCategoryComponent = () => {
  const { t } = useTranslation();
  const dispatch = useDispatch();
  useEffect(() => {
    dispatch(CosmeticsCategoryGet())
  }, [])
    const data = useSelector(state => state.cosmeticCategory.cosmeticsCategoryGet?.data)
...
export default BioCategoryComponent;
